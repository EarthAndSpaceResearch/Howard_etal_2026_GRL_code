%% script to correct SWOT Raster Tiles for DAC and tides
% Input: 
...
%       
%  this script is current set to read SWOT tiles in specified directory and correct
%  each one for:
%      - ocean tides (using CATS2008_v2023 model) 
%      - DAC (using AVISO DAC product)
%
%  Corrected tiles (*_correctedDACTIDES.mat) are written desired directory
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
dirsrc='..\..\..\GRL2026_paperdata\fig3\SWOT_HR_Venable';
cd(dirsrc)
A=dir('*.nc');
cd(b)
[m,~]=size(A);
