...
Scripts and a "readme" file for each figure are located in the Code directory and organized by figure:
...
The user is responsible for accessing data. See [Howard_et_al2026_data_and_software_access.pdf](docs/Howard_et_al2026_data_and_software_access.pdf)  for links to datasets used in this paper.
